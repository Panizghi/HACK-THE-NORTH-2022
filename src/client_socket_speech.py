...
class SpeechCommandPrediction:
    ...
    def return_prediction(self):
        ...
        if self.keyword == "take off":
            self.pred_vector["direction"] = "take off"
            self.pred_vector["magnitude"] = 5.0

        elif self.keyword == "land" or self.keyword == "touchdown":
            self.pred_vector["direction"] = "land"
            self.pred_vector["magntidue"] = 5.0
            ...
            self.pred_vector["direction"] = "up"
            self.pred_vector["magnitude"] = 5.0

        elif self.keyword == "down":
            self.pred_vector["direction"] = "down"
            self.pred_vector["magnitude"] = 5.0

        elif self.keyword == "turn left":
            self.pred_vector["direction"] = "turn left"
            self.pred_vector["magnitude"] = 5.0

        elif self.keyword == "turn right":
            self.pred_vector["direction"] = "down"
            self.pred_vector["magnitude"] = 5.0
...
# asyncio.run(connect_to_master_api())
